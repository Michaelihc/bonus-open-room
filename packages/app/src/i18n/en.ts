export const dict = {
  ...
  "prompt.example.1": "Prepare the BONUS workspace under .bonus/",
  "prompt.example.2": "Extract an API spec from .bonus/source/",
  "prompt.example.3": "Write a conformance plan for this binary format",
  "prompt.example.4": "List compatibility requirements from the uploaded SDK",
  "prompt.example.5": "Document observed CLI behavior and edge cases",
  "prompt.example.6": "Summarize the closed-source configuration format",
  "prompt.example.7": "Turn sample files into executable compatibility tests",
  "prompt.example.8": "Identify unknowns that still need source inspection",
  "prompt.example.9": "Create a provenance record for the clean-room handoff",
  "prompt.example.10": "Implement the replacement from the BONUS spec",
  "prompt.example.11": "Generate tests for the clean-room implementation",
  "prompt.example.12": "Scaffold docs for the reimplemented tool",
  "prompt.example.13": "Compare observed behavior across sample inputs",
  "prompt.example.14": "Extract protocol requirements from the docs bundle",
  "prompt.example.15": "Write migration notes from the proprietary SDK",
  "prompt.example.16": "Capture error codes and failure modes in the spec",
  "prompt.example.17": "Translate this file format into validation rules",
  "prompt.example.18": "Create a compatibility checklist for release",
  "prompt.example.19": "Write a clean-room implementation README",
  "prompt.example.20": "Summarize what can and cannot be open-sourced",
  "prompt.example.21": "Build conformance fixtures from uploaded samples",
  "prompt.example.22": "Document the observable startup workflow",
  "prompt.example.23": "Implement parser tests from the extracted spec",
  "prompt.example.24": "Create a replacement CLI command set",
  "prompt.example.25": "Review the BONUS handoff for missing requirements",
  ...
  "home.empty.title": "Start Your BONUS Workspace",
  "home.empty.description": "Open a project directory to begin clean-room development with isolated analysis and implementation lanes",
  ...
  "session.new.title": "Create BONUS Session",
  ...
  "app.name.desktop": "BONUS Desktop",
