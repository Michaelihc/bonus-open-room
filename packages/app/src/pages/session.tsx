...
import type { BonusWorkflowPreset } from "@/utils/bonus-workflow"
...
export default function Page() {
  ...
  const [store, setStore] = createStore({
    ...
    newSessionWorkflow: "analysis" as BonusWorkflowPreset,
    deferRender: false,
  })
      ...
      <div class="flex-1 min-h-0 flex flex-col md:flex-row">
        ...
        >
            ...
            <Switch>
              ...
              <Match when={true}>
                <NewSessionView
                  ...
                  workflow={store.newSessionWorkflow}
                  onWorkflowSelect={(workflow) => setStore("newSessionWorkflow", workflow)}
                />
              </Match>
            </Switch>
          </div>
          ...
          <SessionComposerRegion
            ...
            newSessionWorkflow={store.newSessionWorkflow}
            onNewSessionWorkflowReset={() => setStore("newSessionWorkflow", "analysis")}
            onSubmit={() => {
              comments.clear()
              resumeScroll()
            }}
