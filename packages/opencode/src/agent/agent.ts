...
import PROMPT_ANALYSIS from "./prompt/analysis.txt"
import PROMPT_CLEANROOM from "./prompt/cleanroom.txt"
        ...
        Effect.fn("Agent.state")(function* (ctx) {
          ...
          const agents: Record<string, Info> = {
            ...
            analysis: {
              name: "analysis",
              description:
                "BONUS analysis lane. Reverse engineers behavior into specs, conformance assets, and provenance without writing implementation code.",
              ...
              permission: Permission.merge(
                ...
                Permission.fromConfig({
                  ...
                  edit: {
                    "*": "deny",
                    ".bonus/README.md": "allow",
                    ".bonus/spec*": "allow",
                    ".bonus/conformance*": "allow",
                    ".bonus/provenance*": "allow",
                    ".bonus/notes*": "allow",
                  },
                }),
                user,
            ...
            cleanroom: {
              name: "cleanroom",
              description:
                "BONUS clean-room lane. Reimplements software from specs and conformance assets without consulting uploaded closed-source materials.",
              prompt: PROMPT_CLEANROOM,
              permission: Permission.merge(
                defaults,
                Permission.fromConfig({
                  question: "allow",
